...
# ------------------------------  MAIN BODY  ---------------------------
t_eop = Table.read(eop_file, , format="ascii",
                   names=["time_tag_pmr", "db_name",
                          "xp", "yp", "ut1_tai", "dX", "dY",
                          "xp_rate", "yp_rate", "ut1_rate",
                          "xp_err", "yp_err", "dut_err", "dX_err", "dY_err",
                          "xp_rate_err", "yp_rate_err", "ut1_rate_err",
                          "xp_yp_corr", "xp_ut1_corr", "yp_ut1_corr", "dX_dY_corr",
                          "ut1_ut1rate_corr", "xp_ut1rate_err", "yp_ut1rate_corr",
                          "sess_dur", "wrms", "num_obs", "time_tag_nut", "network"])
# ------------------------------ END -----------------------------------
